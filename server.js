...
/* General modules */
const { Player } = require('./src/server_modules/Player')
const { findRoom } = require('./src/server_modules/findRoom')
const { ChessRoom } = require('./src/server_modules/ChessRoom')
const { GetPieces} = require('./src/server_modules/GetPieces')
const { switchTurns } = require('./src/server_modules/SwitchTurns')
const { GameOutcome } = require('./src/server_modules/GameOutcome')
const { validateMove } = require('./src/server_modules/validateMove')
const { handleCheckmate } = require('./src/server_modules/handleCheckmate')
const { fullFenValidation } = require('./src/server_modules/fullFenValidation')

/* Socket.io modules */
const initSoundBoard = require('./src/soundboard/soundBoard');
...
io.on('connection', (socket) => {
  ...
  if(socket.handshake.query.landscape === 'backend') console.log('Someone special has joined, give them backdoor chess privileges');
