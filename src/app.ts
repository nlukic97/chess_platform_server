module.exports = function(){
    ...
    const { ChessRoom } = require('./modules/ChessRoom')
    const { GetPieces} = require('./modules/GetPieces')
    const { switchTurns } = require('./modules/SwitchTurns')
    const { GameOutcome } = require('./modules/GameOutcome')
    const { validateMove } = require('./modules/validateMove')
    const { handleCheckmate } = require('./modules/handleCheckmate')
    const { fullFenValidation } = require('./modules/fullFenValidation')
